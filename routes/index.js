...
indexRouter.post("/additem", formController.validateForm);
...
indexRouter.post("/updateitem", formController.validateUpdateForm);
indexRouter.post("/updateitem", inventoryController.updateItemPost);
